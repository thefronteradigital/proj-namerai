  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-extrabold text-slate-900 tracking-tight mb-4">
        Namer.ai - AI-Powered Brand Name Generator
      </h1>
      <p className="text-slate-600 text-base md:text-lg max-w-xl leading-relaxed">
        Create unique, multilingual brand names powered by AI with domain
        availability checks • 200 free domain checks/day
      </p>
    </div>
  );
}
